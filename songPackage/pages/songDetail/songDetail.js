...
Page({
  ...
  onLoad: function (options) {
    // option: 用于接收路由跳转的query参数
    // 原生小程序中的路由传参，对参数的长度有限制，如果参数长度过长自动截取
    // 所以不算json数据了
    ...
    /* 
      ...
      解决方案：
        1.控制音频的实例 backgroundAudioManager 去监视音乐的播放和暂停
    */
  ...
  async musicControl(isPlay,musicId,musicLink){
    ...
    if(isPlay){ // 音乐播放
      if(!musicLink){
        // 获取音乐的播放链接
        let musicLinkData = await request('/song/url',{id: musicId},'get')
